...
const ModelComponent = ({ id }) => {
  ...
  return (
    <>
      <section className="relative z-10 py-16 dark:bg-black md:py-20 lg:py-28">
                        ...
                        <div className="w-full">
                          <div className="pb-4">
                            <div className="flex justify-between">
                              ...
                              <button
                                data-variant="flat"
                                className="inline-flex h-7 w-16 transform-none items-center justify-center rounded border border-zinc-300 bg-zinc-400 text-center font-semibold normal-case leading-6 text-black shadow-sm transition duration-150 ease-in-out hover:border-zinc-300 hover:bg-zinc-400 hover:text-zinc-200 focus:outline-none focus:ring-2 focus:ring-opacity-50"
                              >
                                RESET
                              </button>
                            </div>
                            <textarea
                              ...
                              className="my-2 mb-4 w-full min-w-0 flex-auto appearance-none rounded-md border border-zinc-900/10 bg-white p-1 px-3 text-gray-900 shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-violet-500 focus:outline-none focus:ring-4 focus:ring-violet-500/10 sm:text-sm"
                            ></textarea>
                            <p className="h-15 my-2 w-full text-left text-sm text-gray-500 dark:text-white">
                              The base prompt allows you to customize your
                              chatbot's personality and style. Please make sure
                              to experiment with the base prompt by making it
                              very specific to your data and use case.
                            </p>
                          </div>
                          <div className="pb-6">
                            <p className="text-md h-10 text-left text-black dark:text-white">
                            ...
                            >
                              ...
                              <option value="gpt-4" disabled={false}>
                                gpt-4
                              </option>
                            </select>
                            <p className="h-22 my-2 w-full text-left text-sm text-gray-500 dark:text-white">
                              gpt-4 is much better at following the base prompt
                              and not hallucinating, but it's slower and more
                              expensive than gpt-3.5-turbo (1 message using
                              gpt-3.5-turbo costs 1 message credit. 1 message
                              using gpt-4 costs 20 message credits)
                            </p>
                          </div>
                          <div className="pb-4">
                            <p className="text-md mb-2 h-10 text-left text-black dark:text-white">
                              Temperature
                            </p>
                            ...
                            <input
                              ...
                              className="mb-2 h-2 w-full cursor-pointer appearance-none rounded-lg bg-gray-200 accent-violet-700 dark:bg-gray-700"
                            />
                            <div className="flex justify-between">
